              ...
              <li v-for="(info, key) in contactInfo" :key="key" class="mb-4">
                ...
                >
                  ...
                  >
                    <i
                      class="contact-icon"
                      :class="contactInfo[key].iconClass"
                    ></i>
                  </div>
                  <div
              ...
              >
                ...
                <ul class="community-link-list d-flex flex-row">
                  <li
                    ...
                    :key="key"
                    @click="openNewTab(communityLinks[key].link)"
                  >
                    <i :class="communityLinks[key].iconClass"></i>
                  </li>
                </ul>
              </div>
              <!-- 社群連結結束 -->
                ...
                >
                  <div class="input-group mb-3">
                    <input
                      ...
                      type="email"
                      class="form-control"
                      :class="subscribeData.inputSensitive ? classes : ''"
                      placeholder="請輸入電郵地址..."
                      v-model="subscribeData.subscribeEmail"
                      @input="subscribeData.inputSensitive = true"
                      @focus="subscribeData.inputSensitive = true"
                      @blur="subscribeData.inputSensitive = true"
                    />
          ...
          <div class="ml-sm-auto ml-3 my-sm-0 my-1">
            ...
            >
              <li
                ...
                @mouseleave="showFakePrivacyPolicy = false"
              >
                隱私權政策
                <div
                  v-if="showFakePrivacyPolicy"
                  class="reminder-bubble position-absolute d-flex justify-content-center align-items-center"
                >
                  僅做樣式，無效果
                </div>
              </li>
              <li
                class="ml-3"
                @click="openNewTab('https://www.104.com.tw/jobs/main/')"
              >
                加入甲必丹
              </li>
            </ul>
    ...
    li {
      ...
      .reminder-bubble {
        ...
        &::after {
          ...
          border-color: $scuba-blue transparent transparent;
          z-index: 1;
          position: absolute;
          transform: translate3d(-50%, -50%, 0);
          top: 100%;
